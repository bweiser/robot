/* Auto-generated by genmsg_cpp for file /opt/planetxrobots/ros/DriveMotors/srv/Move.srv */
...
{
template<class ContainerAllocator> struct IsMessage< ::DriveMotors::MoveRequest_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::DriveMotors::MoveRequest_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
...
namespace message_traits
{
template<class ContainerAllocator> struct IsMessage< ::DriveMotors::MoveResponse_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::DriveMotors::MoveResponse_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
